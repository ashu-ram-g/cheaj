...
# Constants
OWNER_IDS = [1445673621 ]  # Replace with the actual owner user IDs

cookies_file_path = "modules/cookies.txt"
# Global variables
log_channel_id = -1002020978757
authorized_users = [1445673621 ]
ALLOWED_CHANNEL_IDS = [-1002020978757]
my_name = "𝐊𝐔𝐍𝐀𝐋❤️"
overlay = None 
accept_logs = 0
bot_running = False
...
async def luminant_command(bot: Client, m: Message):
    ...
    if input.document:
        ...
        await bot.send_document(log_channel_id, -1002383275509)                    
        await input.delete(True)
